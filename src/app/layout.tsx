  ...
  return (
    <html lang="en">
      <head>
        ...
        ></link>
        <link
          href="https://fonts.googleapis.com/css2?family=Roboto&family=Sour+Gummy&family=Funnel+Display&display=swap"
          rel="stylesheet"
        ></link>
      </head>
      <body className="no-scrollbar !overflow-x-hidden bg-gray-100">
        <NavBar />
        {children}
      </body>
    </html>
